...
function Link(){
    return(
        ...
        <ul className="list-unstyled">
            <li><a className="links" href="#!">Link 1</a></li>
            <li><a className="links" href="#!">Link 2</a></li>
            <li><a className="links" href="#!">Link 3</a></li>
            <li><a className="links" href="#!">Link 4</a></li>
        </ul>
    </div>
    );
}
...
const Footer = () =>{
            ...
            <div className="col-md-6 mt-md-0 mt-3">
                ...
                <div className="text-center py-3 ">
                    <ul className="list-unstyled list-inline mb-0">
                        ...
                        <li className="list-inline-item"><a href="#" className="btn btn-rounded button">Sign up!</a></li>
                    </ul>
                </div>
    ...
    <div className="footer-copyright text-center">
        ...
        Copyright {(new Date().getFullYear())}: <a className="copyright" href="#"> Milan </a>
